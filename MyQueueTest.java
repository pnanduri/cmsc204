...
public class MyQueueTest {
	...
	public void testDequeueStudent() {
		...
		try {
			...
			assertEquals("3.5", doubleQ.dequeue().toString());
			assertEquals("1.5", doubleQ.dequeue().toString());
			//Queue is empty, next statement should cause QueueUnderFlowException
			doubleQ.dequeue();
			doubleQ.dequeue();
			doubleQ.dequeue();
	...
	public void testEnqueueStudent() {
		...
		try {
			...
			assertEquals(true, doubleQ.enqueue(100.0));
			assertEquals(4, doubleQ.size());
			assertEquals(true, doubleQ.enqueue(55.0));
	...
	public void testToStringStudent() throws QueueOverflowException {
		...
		assertEquals("2.53.51.5", doubleQ.toString());
		doubleQ.enqueue(5.5);
		assertEquals("2.53.51.55.5", doubleQ.toString());
		doubleQ.enqueue(100.0);
		assertEquals("2.53.51.55.5100.0", doubleQ.toString());
