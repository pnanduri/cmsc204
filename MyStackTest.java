...
public class MyStackTest {
	...
	public void testPopStudent() {
		...
		try {
			assertTrue(doubleS.pop().equals(1.5));
			assertTrue(doubleS.pop().equals(3.5));
			assertTrue(doubleS.pop().equals(2.5));
			//Queue is empty, next statement should cause QueueUnderFlowException
			doubleS.pop();
			assertTrue("This should have caused an StackUnderflowException", false);
		}
	...
	public void testPushStudent() {
		...
		try {
			...
			assertEquals(true, doubleS.push(4.5));
			assertEquals(4, doubleS.size());
			assertEquals(true, doubleS.push(100.0));
	...
	public void testToStringStudent() throws StackOverflowException {
		//Use the doubleQ for student tests
		assertEquals("2.53.51.5", doubleS.toString());
		doubleS.push(4.5);
		assertEquals("2.53.51.54.5", doubleS.toString());
		doubleS.push(100.0);
		assertEquals("2.53.51.54.5100.0", doubleS.toString());
	}
